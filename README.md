...
- **GVM (Greenbone Vulnerability Manager)**: Automating secure, isolated deployments for vulnerability scanning in air-gapped labs.
...
Systems: Kali Linux, Ubuntu, Windows (VM sandboxing)
Infra: Apache, Nginx, Docker, systemd, SSH, firewalld
Shells: Zsh (Agnoster theme), tmux, GNU coreutils
